...
# gera o vmlinux.h a partir do BTF do kernel em execução (precisa CONFIG_DEBUG_INFO_BTF)
vmlinux.h:
	$(BPFTOOL) btf dump file /sys/kernel/btf/vmlinux format c > vmlinux.h

# compila o objeto BPF.
tcpco.bpf.o: tcpco.bpf.c vmlinux.h
	$(CLANG) $(BPF_CFLAGS) -c $< -o $@

# gera o skeleton .h a partir do objeto BPF
tcpco.skel.h: tcpco.bpf.o
	$(BPFTOOL) gen skeleton $< > $@

# compila o loader user-space linkando com libbpf
